...
# STRICT SYSTEM PROMPT (Your Fix #1)
SYSTEM_PROMPT = """You are AIRGO, a flight booking assistant for Nigerian travelers.
...
For other messages, be warm and helpful. When users book, collect:
- Full name
- Phone number
- Email
...
async def chat(chat_message: ChatMessage):
    try:
        ...
        if any(keyword in message for keyword in ["flight", "book", "fly", "lagos", "abuja"]):
            origin = None
            destination = None
            ...
            if origin and destination:
                ...
                if amadeus_response:
                    flight_data = amadeus_response  # ✅ FIXED
